...
public class UploadPhotoService {
    ...
    public void uploadPhoto(SalesmanLogin user , Map params , ResponseData response){
        ...
        if(UtilsConstant.strIsEmpty(customer_no)){

            log.info("业务员" +  user.getLoginID() + "上传照片没有上传 商户号,");
        ...
        if(customerMap == null || customerMap.isEmpty()){
            ...
            log.info("未查到商户号：" + uploadPhotoModel.getCustomerNo() + " 商户信息");
        ...
        try {
            ...
            if (!UtilsConstant.strIsEmpty(IDCardFrontPhoto)) {
                ...
                log.info(user.getLoginID() + "保存身份证正面照片成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(IDCardReversePhoto)) {
                ...
                log.info(user.getLoginID() + "保存身份证反面照片成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(businessPhoto)) {
                ...
                log.info(user.getLoginID() + "保存营业执照照片成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(openingLicensePhoto)) {
                ...
                log.info(user.getLoginID() + "保存开户许可证成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(storeFontPhoto)) {
                ...
                log.info(user.getLoginID() + "保存店面照片成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(interiorPhoto)) {
                ...
                log.info(user.getLoginID() + "保存店内内景成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(streetPhoto)) {
                ...
                log.info(user.getLoginID() + "保存街道照片成功" + imgName);
            } else {
            ...
            if (!UtilsConstant.strIsEmpty(otherPhoto)) {
                ...
                log.info(user.getLoginID() + "保存其他照片成功" + imgName);
            } else {
